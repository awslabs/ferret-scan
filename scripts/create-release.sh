...
print_info "GitHub Actions will now build and release automatically"
print_info "Monitor progress at: https://github.com/awslabs/ferret-scan/actions/workflows/release.yml"

echo ""
print_info "Release process initiated! The following will happen automatically:"
echo "  1. GitHub Actions will detect the new tag"
echo "  2. GoReleaser will build binaries for Linux, macOS, and Windows"
