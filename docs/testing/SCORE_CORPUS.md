...
| **4 unredactable file types** | `.tsv`, `.html`, `.sql` have no registered redactor. A disclosed CLI limitation, not a leak; the sink skips them and names them rather than recording a fake pass. |
